...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  for(var i =0; i < arreglo.length - 1; i++){ //Le ponemos el -1 asi al final de la iteracion, no compara con un indice inexistente.
